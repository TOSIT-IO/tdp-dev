...
2. Run the container:
    ...
    **Note**: The Node IP addresses are the same as in the default `tdp-vagrant/vagrant.yml`. You may use other IP addresses by adding the environment variable for each node IP like for instance `-e MASTER_01_IP="192.168.72.21`
